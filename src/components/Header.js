        ...
        <div className="inner">
          ...
          <div className="box">
            <div className="box_top">
              <ul>
                <li>
                  <a href="https://www.theborn.co.kr/" target="_blank">
                    더본코리아
                  </a>
                </li>
                <li>
                  <a
                    href="https://www.instagram.com/paikscoffee_official/"
                    target="_blank"
                  >
                ...
                <li>
                  <a
                    href="https://ko-kr.facebook.com/ipaikscoffee/"
                    target="_blank"
                  >
                ...
                {data &&
                  data.map((v, i) => (
                    <li
                      key={i}
                      data-index={i}
                      onMouseEnter={v.submenu && onBgOn}
                      onMouseLeave={onBgOut}
                      onClick={navListOpenMo}
                    >
                      <MenuLink
                        href={viewPort >= 1200 && v.submenu ? v.url : "#"}
                      >
                        {v.title}
                      </MenuLink>
                      <ul
                        ref={(el) => (subMenu.current[i] = el)}
                        className="sub_menu"
                      >
                        {v.submenu &&
                          v.submenu.map((v, i) => (
